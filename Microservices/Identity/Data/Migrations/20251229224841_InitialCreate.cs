        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneCode = table.Column<string>(type: "text", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatePlace = table.Column<string>(type: "text", maxLength: 100, nullable: false),
                    ...
                    GoogleAccessToken = table.Column<string>(type: "text", maxLength: 500, nullable: true),
                    GoogleRefreshToken = table.Column<string>(type: "text", maxLength: 500, nullable: true),
                    SecurityCode = table.Column<string>(type: "text", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferredId = table.Column<long>(type: "bigint", nullable: false),
                    UsedSecurityCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_referral_Users_ReferredId",
                        column: x => x.ReferredId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_user_referral_Users_ReferrerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_referral_ReferredId",
                table: "user_referral",
                column: "ReferredId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_user_referral_ReferrerId",
                table: "user_referral",
                column: "ReferrerId");

            migrationBuilder.CreateIndex(
                name: "IX_user_referral_UsedSecurityCode",
                table: "user_referral",
                column: "UsedSecurityCode");
