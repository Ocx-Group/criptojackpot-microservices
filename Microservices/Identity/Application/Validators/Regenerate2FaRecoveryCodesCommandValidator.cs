...
public class Regenerate2FaRecoveryCodesCommandValidator 
    : AbstractValidator<Regenerate2FaRecoveryCodesCommand>
{
    public Regenerate2FaRecoveryCodesCommandValidator()
    {
