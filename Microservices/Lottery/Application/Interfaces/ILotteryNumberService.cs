...
public interface ILotteryNumberService
{
    ...
    /// </summary>
    Task<List<AvailableNumberDto>> GetAvailableNumbersAsync(Guid lotteryGuid);
    ...
    Task<Result<List<NumberReservationDto>>> ReserveNumberByQuantityAsync(Guid lotteryGuid, int number, int quantity, long userId);
    ...
    /// </summary>
    Task<List<NumberStatusDto>> GetNumberStatusesAsync(Guid lotteryGuid);
}
