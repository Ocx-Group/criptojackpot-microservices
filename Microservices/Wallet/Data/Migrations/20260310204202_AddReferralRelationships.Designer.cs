...
namespace CryptoJackpot.Wallet.Data.Migrations
{
    ...
    [Migration("20260310204202_AddReferralRelationships")]
    partial class AddReferralRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoJackpot.Wallet.Domain.Models.ReferralRelationship", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid>("ReferredUserGuid")
                        .HasColumnType("uuid")
                        .HasColumnName("referred_user_guid");

                    b.Property<Guid>("ReferrerUserGuid")
                        .HasColumnType("uuid")
                        .HasColumnName("referrer_user_guid");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_referral_relationships");

                    b.HasIndex("ReferredUserGuid")
                        .IsUnique()
                        .HasDatabaseName("ix_referral_relationships_referred_user_guid");

                    b.HasIndex("ReferrerUserGuid")
                        .HasDatabaseName("ix_referral_relationships_referrer_user_guid");

                    b.ToTable("referral_relationships", (string)null);
                });
